		...
		<div className="min-h-screen flex flex-col items-center justify-center bg-[var(--bg-primary)] p-4 relative overflow-hidden">
			...
			<div className="glass-panel w-full max-w-md p-8 relative z-10">
				<div className="text-center mb-8">
					<Link
						href="/"
						className="text-2xl font-bold tracking-tighter text-[var(--text-primary)] hover:opacity-80 transition-opacity flex flex-col items-center gap-2"
					>
						<img
							src="/enzo.png"
							alt="Enzo"
					...
					<p className="text-[var(--text-secondary)] text-sm">
						Sign in to manage your master profile.
					</p>
				</div>
