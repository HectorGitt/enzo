            ...
            <div className="glass-panel w-full max-w-md p-8 relative z-10">
                ...
                <div className="space-y-4 mb-6">
                    ...
                    <button
                        ...
                        className="w-full bg-white text-black border border-black/10 font-bold py-3 rounded flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors"
                    >
                    ...
                    <button
                        ...
                        className="w-full bg-[#0A66C2] text-white font-bold py-3 rounded flex items-center justify-center gap-2 hover:opacity-90 transition-opacity"
                    >
                ...
                <form onSubmit={handleCredentialsLogin} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-[var(--text-primary)] text-white font-bold py-3 rounded hover:opacity-90 transition-opacity disabled:opacity-50"
                    >
