			...
			<div className="min-h-screen flex flex-col relative overflow-hidden bg-[var(--bg-primary)]">
				...
				<main className="z-10 flex-grow">
					...
					<section className="pt-32 pb-24 text-center px-6 relative">
						...
						>
							Enzo listens to your code commits, remembers your
							achievements, and uses AI to build your resume,
							portfolio, and performance reviews automatically.
						</motion.p>
							...
							>
								<div className="p-12 md:w-1/2 flex flex-col justify-center">
									...
									<p className="text-lg text-[var(--text-secondary)] mb-8 leading-relaxed">
										Forget what you did last month? Just ask
										Enzo. Our Agentic RAG system searches
										your commits, PRs, and wins to answer
										complex career questions.
									</p>
								...
								<div className="md:w-1/2 bg-gray-50 border-l border-black/5 p-8 flex items-center justify-center">
									...
									<div className="w-full max-w-md bg-white rounded-xl shadow-lg border border-black/5 overflow-hidden transform transition-all hover:scale-105 duration-500">
										...
										<div className="p-3 border-t bg-gray-50">
											<div className="h-10 bg-white border rounded-lg w-full flex items-center px-4 text-gray-400 text-sm">
												Type a message...
											</div>
										</div>
									</div>
						...
						<div className="container mx-auto px-6">
							...
							>
								...
								<p className="text-[var(--text-secondary)] text-lg">
									Enzo connects the dots between your code and
									your career.
								</p>
							</motion.div>
							...
							>
								...
								<motion.div
									variants={fadeInUp}
									className="p-8 rounded-2xl bg-white border border-black/5 shadow-sm hover:shadow-xl transition-all hover:border-[var(--accent-cyan)]/30 group"
								>
									...
									<p className="text-[var(--text-secondary)]">
										Enzo listens to GitHub events
										automatically. We filter out the noise
										(typo fixes) and keep the signal
										(performance wins).
									</p>
								</motion.div>
								...
								<motion.div
									variants={fadeInUp}
									className="p-8 rounded-2xl bg-white border border-black/5 shadow-sm hover:shadow-xl transition-all hover:border-[var(--accent-purple)]/30 group"
								>
									...
									<p className="text-[var(--text-secondary)]">
										A Kanban board for your career. Drag and
										drop raw commits to turn them into
										executive-ready "Highlights".
									</p>
								</motion.div>
								...
								<motion.div
									variants={fadeInUp}
									className="p-8 rounded-2xl bg-white border border-black/5 shadow-sm hover:shadow-xl transition-all hover:border-pink-200 group"
								>
									...
									<p className="text-[var(--text-secondary)]">
										Generate pixel-perfect PDFs tailored to
										specific roles. Support for custom Word
								...
								<motion.div
									variants={fadeInUp}
									className="p-8 rounded-2xl bg-white border border-black/5 shadow-sm hover:shadow-xl transition-all hover:border-orange-200 group"
								>
									...
									<p className="text-[var(--text-secondary)]">
										Need a bio for a conference? A cover
										letter? Enzo uses Gemini 2.5 Flash to
										write professional content in your tone.
									</p>
								</motion.div>
								...
								<motion.div
									variants={fadeInUp}
									className="p-8 rounded-2xl bg-white border border-black/5 shadow-sm hover:shadow-xl transition-all hover:border-green-200 group"
								>
									...
									<p className="text-[var(--text-secondary)]">
										Claim `enzo.stabilty.com/p/yourname`. A
										verified, always-updated portfolio that
										proves your skills with actual code
										evidence.
									</p>
								</motion.div>
								...
								<motion.div
									variants={fadeInUp}
									className="p-8 rounded-2xl bg-white border border-black/5 shadow-sm hover:shadow-xl transition-all hover:border-gray-200 group"
								>
									...
									<p className="text-[var(--text-secondary)]">
										Your code is safe. We use secure GitHub
										Apps, encrypted tokens, and never train
										public models on your private code.
									</p>
								</motion.div>
							</motion.div>
						</div>
							...
							<div className="flex flex-col md:flex-row items-center gap-12">
								<div className="md:w-1/2">
									...
									<p className="text-lg text-gray-400 mb-8 leading-relaxed">
										You don't need to manually update a
										database. Enzo connects to your GitHub
										and runs in the background. It parses
										your commit history, filters the noise,
										and pushes updates to your portfolio
										automatically.
									</p>
									...
									<div className="rounded-xl overflow-hidden shadow-2xl border border-gray-800 bg-gray-950 font-mono text-sm">
										...
										<div className="p-6 space-y-2">
											...
											<div className="text-gray-500">
												...
												<br />
												<span className="pl-4">
													- facebook/react: 3 new
													commits
												</span>
												<br />
												<span className="pl-4">
													- vercel/next.js: 1 merged
													PR
												</span>
											</div>
											...
											<div className="text-gray-300 mt-4">
												...
												enzo deploy
												--target=enzo.stability.com
											</div>
											<div className="text-gray-500 mt-2">
												[+] Updating live resume...{" "}
												<span className="text-green-500">
													OK
												</span>
												<br />
							...
							>
								...
								<div className="bg-white rounded-xl shadow-xl border border-black/5 overflow-hidden text-left p-8 md:p-12 relative z-10">
									<div className="flex flex-col md:flex-row gap-8 mb-8 border-b border-gray-100 pb-8">
										...
										<div>
											...
											<div className="flex flex-wrap gap-2">
												...
												<span className="px-3 py-1 rounded-full bg-[var(--accent-cyan)]/10 text-[var(--accent-cyan)] text-sm font-medium border border-[var(--accent-cyan)]/20">
													Open to Work
												</span>
											</div>
										</div>
									...
									<div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-white via-white/80 to-transparent flex items-end justify-center pb-8">
										<Link
											href="/dashboard"
											className="px-8 py-3 bg-[var(--accent-cyan)] text-white rounded-full font-bold shadow-lg hover:brightness-110 hover:scale-105 transition-all flex items-center gap-2"
										>
											Claim Your Page{" "}
							...
							<div className="grid md:grid-cols-4 gap-12 mb-12">
								<div className="col-span-1 md:col-span-2">
									...
									<p className="text-[var(--text-secondary)] max-w-sm">
										The AI Career Copilot. Stop writing
										resumes manually. Start syncing your
