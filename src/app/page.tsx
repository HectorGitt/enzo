			...
			<main className="z-10 flex-grow">
				...
				<section className="pt-32 pb-20 text-center px-6">
					...
					<p className="text-xl text-[var(--text-secondary)] max-w-2xl mx-auto mb-10 leading-relaxed font-light">
						Your work doesn't disappear when you close your laptop.{" "}
						<br />
						Enzo syncs your code commits and wins directly to a live
						resume.
					</p>
						...
						<div className="grid md:grid-cols-2 gap-16 items-center">
							<div>
								...
								<p className="text-[var(--text-secondary)] mb-6 text-lg leading-relaxed">
									Every day you solve complex problems, fix
									critical bugs, and optimize systems. But
									when performance review time comes, you're
									scrolling through Slack trying to remember
									what you did last month.
								</p>
								<p className="text-lg text-[var(--text-primary)] font-medium">
									That's Career Amnesia. And it's costing you
									promotions.
								</p>
							</div>
					...
					<div className="container mx-auto px-6 text-center">
						...
						<div className="grid md:grid-cols-3 gap-8">
							...
							<div className="relative group">
								...
								<p className="text-[var(--text-secondary)] text-sm px-4">
									Our engine filters noise and formats your
									work into impact-driven "Wins".
								</p>
							</div>
							...
							<div className="relative group">
								...
								<p className="text-[var(--text-secondary)] text-sm px-4">
									Generate a clean PDF resume or share your
									always-updated public portfolio.
								</p>
							</div>
						</div>
					</div>
						...
						<div className="grid md:grid-cols-2 gap-6">
							<div className="glass-panel p-8 hover:border-[var(--accent-cyan)]/30 transition-colors">
								...
								<p className="text-[var(--text-secondary)]">
									Connect your repositories and let Enzo fetch
									performance improvements, big features, and
							...
							<div className="glass-panel p-8 hover:border-[var(--accent-purple)]/30 transition-colors">
								...
								<p className="text-[var(--text-secondary)]">
									...
									formatted PDF with your latest wins in one
									click.
								</p>
							</div>
							<div className="glass-panel p-8 hover:border-black/20 transition-colors">
								...
								<p className="text-[var(--text-secondary)]">
									...
									professional page to share with recruiters.
								</p>
							</div>
							<div className="glass-panel p-8 hover:border-[var(--accent-cyan)]/30 transition-colors">
								<h3 className="text-2xl font-bold mb-4 text-[var(--accent-cyan)]">
								...
								<p className="text-[var(--text-secondary)]">
									Connect your portfolio repository and Enzo
									will automatically submit Pull Requests to
									update your site with new wins.
								</p>
							</div>
						</div>
					</div>
